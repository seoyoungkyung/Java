...
public class MainMenu extends AbstractMenu { // 메인 메뉴의 출력과 입력에 따른 처리를 담당
	...
	private void reserve() {
		...
		ArrayList<Reservation> reservations = Reservation.findMovieId(movieId);		//예매 영화 좌석 현황 출력
		...
		//예매 객체 생성 및 저장
		Reservation reservation = new Reservation(movie.getId(), movie.getTittle(), seatName);
	...
	private void cancelReservation() {
		System.out.println("예매를 취소할 번호를 입력하세요: ");
